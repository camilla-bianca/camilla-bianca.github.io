...
export const education = [
  {
    role: 'Game Development (Diploma di Tecnico Superiore)',
    company: 'ITS Academy Lazio Digital',
    period: 'Nov 2022 → Lug 2024',
    description: '',
  },
  {
    role: 'Ingegneria Informatica (Laurea Magistrale)',
    company: 'Università degli Studi Roma Tre',
    period: 'Set 2017 → Mar 2020',
    description: '',
  },
  {
    role: 'Ingegneria Informatica (Laurea Triennale)',
    company: 'Università degli Studi Roma Tre',
